...
export default function Page() {
  ...
  return (
    <Shell title="Command Dashboard">
      <div className="mb-5 grid gap-3 lg:grid-cols-12 lg:items-stretch">
        <button
          type="button"
          onClick={() => setUseF("all")}
          className="anim relative min-h-[180px] overflow-hidden rounded-[28px] p-6 text-left text-white shadow-xl lg:col-span-5 lg:min-h-[280px]"
        >
          ...
          <div className="relative flex h-full flex-col justify-between">
            ...
            <div>
              ...
              <div className="mt-1 text-5xl font-semibold tracking-tight lg:text-6xl">{rows.length}</div>
              <div className="mt-2 text-sm text-slate-300">{nReady} tersedia · {nMaint} bengkel</div>
            </div>
          </div>
        </button>
